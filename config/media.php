...
return [
    ...
    'libraries' => [
        'stylesheets' => [
            'vendor/thienpham/media/packages/jquery-context-menu/jquery.contextMenu.min.css',
            'vendor/thienpham/media/css/media.css?v=' . time(),
        ],
        'javascript' => [
            'vendor/thienpham/media/packages/lodash/lodash.min.js',
            'vendor/thienpham/media/packages/clipboard/clipboard.min.js',
            'vendor/thienpham/media/packages/dropzone/dropzone.js',
            'vendor/thienpham/media/packages/jquery-context-menu/jquery.ui.position.min.js',
            'vendor/thienpham/media/packages/jquery-context-menu/jquery.contextMenu.min.js',
            'vendor/thienpham/media/js/media.js?v=' . time(),
        ],
    ],
    ...
    'default-img' => env('RV_MEDIA_DEFAULT_IMAGE', '/vendor/thienpham/images/placeholder.png'), // Default image
